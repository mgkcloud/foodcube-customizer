...
const tutorialSteps: TutorialStep[] = [
    // Step 0: Welcome introduction
    {
        ...
        content:
            "This interactive tool helps you design custom garden layouts. Let's get started with a quick tutorial to show you the main features. Follow the highlighted steps!",
        targetId: "config-overlay",
        fallbackTargetIds: [
            "foodcube-configurator",
            "configurator-title",
            "grid-wrapper",
        ],
        position: "top",
    ...
    // Step 1: Select L-shape (INTERACTIVE)
    {
        ...
        content:
            "👉 CLICK ON THE L-SHAPE BUTTON to begin with a preset layout. This will place several cubes on your grid in an L-shape pattern.",
    ...
    // Step 2: Remove a cube (INTERACTIVE)
    {
        ...
        title: "Remove a Cube",
        content:
            "👉 Action required: Click on the top-left cube to remove it from the layout.",
    ...
    // Step 3: Add a cube back (INTERACTIVE)
    {
        ...
        title: "Add a Cube",
        content:
            "👉 Action required: Now click on the same empty cell to add the cube back to your layout.",
        targetId: "grid-cell-0-0",
        fallbackTargetIds: ["grid-cell-0-1", "grid-cell-1-0"],
        position: "right",
        alignment: "center",
    ...
    // Step 4: Toggle cladding (INTERACTIVE)
    {
        ...
        content:
            "👉 Action required: Click on this edge panel to toggle the cladding on/off. Cladding panels form the outer walls of your garden.",
        targetId: "grid-cell-0-0-edge-E",
        fallbackTargetIds: [
            "grid-cell-0-0-edge-W",
            "grid-cell-0-0-edge-N",
            "grid-cell-0-0-edge-S",
        ],
        position: "right",
        alignment: "center",
        isInteractive: true,
    ...
    // Step 5: Try another preset (INTERACTIVE)
    {
        ...
        content:
            "👉 Action required: Now let's try the U-Shape layout. Click on the U-Shape configuration button.",
    ...
    // Step 6: Show components
    {
        ...
        content:
            "This panel shows all components needed for your design, including panels and connectors. Notice how it updates as you modify your layout.",
    ...
    // Step 7: Apply design
    {
        ...
        content:
            "When you're satisfied with your design, click 'SELECT & CLOSE' to save your configuration.",
    ...
    // Step 8: Clear option
    {
        ...
        title: "Start Over",
        content:
            "You can clear your design and start over at any time using the 'CLEAR' button.",
...
export const OptimizedTutorial: React.FC = () => {
    ...
    const [interactiveStepCompleted, setInteractiveStepCompleted] =
        useState(false);
    ...
    useEffect(() => {
      ...
      `;
            ...
            console.log(
                "[OptimizedTutorial] Critical tutorial styles injected",
            );
        };
    ...
    useEffect(() => {
        if (
            lastAction?.type === "PRESET_APPLIED" &&
            lastAction.payload &&
            "presetName" in lastAction.payload &&
    ...
    useEffect(() => {
        if (!showTutorial || !ready || currentStep >= tutorialSteps.length)
            return;
        ...
        if (currentTutorialStep.isInteractive && lastAction) {
            const actionSatisfiesStep = checkActionForStep(
                currentTutorialStep,
                lastAction,
            );
            ...
            if (actionSatisfiesStep) {
                ...
                const targetElement =
                    document.querySelector(
                        `[data-testid="${currentTutorialStep.targetId}"]`,
        ...
        <>
            ...
            {showTutorial && ready && (
                <div
                    ...
                    aria-hidden="true"
                    onClick={
                        currentTutorialStep.isInteractive
                            ? undefined
                            : handleNext
                    }
                />
